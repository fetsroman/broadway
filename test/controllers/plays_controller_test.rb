...
class PlaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post plays_url, params: { play: { description: @play.description, director: @play.director, title: @play.title } }
    end
  ...
  test "should update play" do
    patch play_url(@play), params: { play: { description: @play.description, director: @play.director, title: @play.title } }
